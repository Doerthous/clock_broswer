function clock7(){
    function layout(){/*
          <svg version="1.1" id="_clock" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              width="300px" height="300px" viewBox="94.257 101.184 300 300" enable-background="new 94.257 101.184 300 300"
              xml:space="preserve">
    ...
    */}
    function run(){
        var s = Snap(document.getElementById("_clock"));
        ...
        console.log(face);
        dts_setClockTimer(setInterval(update, 1000));
    }
    dts_runClock(layout,"clock7.css",run);
}

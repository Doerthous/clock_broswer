function clock5(){
    function layout(){/*
        <div class="relogio" style="width:550px; height:550px;"></div>
    */}
    function run(){
        (function(w){
          ...
          function loop(){
            ...
            dts_setClockTimer(requestAnimationFrame(loop.bind(this)));
    ...
    dts_runClock(layout,"clock5.css",run);
}
